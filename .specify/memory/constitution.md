...
2. La descripción de cada tool es específica y accionable (ej. "Registra un
   gasto con descripción, monto y categoría, validando el límite acumulado por categoría"), nunca genérica ("maneja gastos").
...
1. Este proyecto reconstruye el sistema "Gastos" de las Sesiones 6-8, cuya
   ...
   sección "Contrato de compatibilidad" de `spec.md` y ninguna
